...
- GPR with different kernel functions
- Random Forest, Gradient Boosting, XGBoost, LightGBM, AdaBoost, and SVR
- Cross-validation and hyperparameter tuning
- Model evaluation and comparison
- Feature importance and SHAP analysis

This project was mainly created as a hands-on exercise to improve my machine learning skills and practice working with a real scientific dataset.

## Reference

Gheytanzadeh et al. (2022), *Scientific Reports*  
https://doi.org/10.1038/s41598-022-10563-8